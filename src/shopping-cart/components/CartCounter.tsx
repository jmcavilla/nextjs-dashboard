...
import { addOne, initCounterState, resetCount, substractOne } from '@/store/slices/counter/counterSlice';
...
export const CartCounter = ({ value = 0 } : Props) => {
    ...
    return (
        <>
            ...
            {/* <div>
                <button onClick={() => dispatch(resetCount(0))} className="flex items-center justify-center p-2 rounded-xl bg-gray-900 text-white hover:bg-gray-600 transition-all w-[100px] mr-2">reset</button>
            </div> */}
        </>
    )
}
